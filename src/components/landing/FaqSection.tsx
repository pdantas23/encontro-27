...
export function FaqSection() {
  ...
  return (
    <EventoSecao id="faq" titulo="Perguntas frequentes">
      <div aria-live="polite">
        {state.status === "loading" ? (
          ...
          <p className="text-[17px] leading-7 text-marrom">As respostas sobre ingressos, pagamento e acesso serão publicadas em breve.</p>
        ) : (
          <>
