 ...
 * reaproveitadas como prova social. Carrossel simples: avança sozinho a cada
...
export function EdicoesAnterioresSection() {
  ...
  return (
    <section aria-labelledby="edicoes-titulo" className="border-t border-border">
      <div className="container-site py-16 sm:py-24">
        <SectionHeading
          id="edicoes-titulo"
          eyebrow="Edições anteriores"
          title="Momentos que continuam presentes"
          description="Experiências, conexões e histórias construídas em cada edição."
          align="center"
        />
